...
import KanbanBoardGroupMenu from './KanbanBoardGroupMenu';
...
/* test group data */
const testGroupData: IEditKanbanBoardGroupPayload = {
  name: 'Test Group',
  status: 'Todo',
  newColIndex: testIdx,
  groupIndex: testIdx,
...
/**
 * Kanban Board Group Menu Unit Tests
 *
 * @author Carl Scrivener {@link https://github.com/rapscallion45 GitHub}
 * @since 0.0.22
 */
describe('Kanban Board Group Menu', () => {
  describe('Values', () => {
  ...
  describe('Functions', () => {
    ...
    it('Should open and close menu popup on button clicks', async () => {
      ...
      expect(screen.getByText('Edit Group Info')).toBeInTheDocument();
