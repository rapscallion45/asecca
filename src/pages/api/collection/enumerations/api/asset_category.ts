...
import { getEnumerationsAssetCategory } from '@/lib/api';

/**
 * Proxy for handling requests to ASECCA Enumerations Asset Category API.
 *
  ...
  switch (method) {
    case 'GET':
      ...
      try {
        ...
        const response = await getEnumerationsAssetCategory();
