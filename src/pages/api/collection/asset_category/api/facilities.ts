...
import { getAssetCategoryFacilities } from '@/lib/api';

/**
 * Proxy for handling requests to ASECCA Asset Category Facilities API.
 *
  ...
  switch (method) {
    case 'GET':
      ...
      try {
        ...
        const response = await getAssetCategoryFacilities();
