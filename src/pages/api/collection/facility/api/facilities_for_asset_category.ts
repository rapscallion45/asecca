...
import { getFacilityAssetCategoryFacilities } from '@/lib/api';

/**
 * Proxy for handling requests to ASECCA Collection Form Facility
 * Asset Category Facilities API.
 *
  ...
  switch (method) {
    case 'GET':
      ...
      try {
        ...
        const response = await getFacilityAssetCategoryFacilities({
